...
@testset "get_set_num_threads" begin
    ...
    # @test_logs (:warn,) match_mode=:any BLAS._set_num_threads(1)
    # if BLAS.vendor() !== :osxblas
    ...
    #         ) === nothing
    #         @test_logs BLAS._set_num_threads(1)
    #         @test @test_logs(BLAS._get_num_threads() === 1
    #         @test_logs BLAS._set_num_threads(2)
    #         @test @test_logs(BLAS._get_num_threads() === 2
    #     end
    # end
end
